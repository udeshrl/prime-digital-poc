...
var groupBox = (function (o) {
    ...
    var minimum = {height: 25, width: 20},
        ...
        defaultSetting = {
            widgetType: "groupBox",
            subViewCollection: [
                {width: 80, height: 30, length: 5, left: 100, top: 250, id: "", type: "Free Text"}
        ...
        singleView = Backbone.View.extend({
            ...
            updateModel: function () {
                var a = this.el;
                this.model.set({left: parseInt(a.css('left'), 10), top: parseInt(a.css('top'), 10), height: a.height(), width: a.width()}, {silent: true});
            },
            checkAnswer: function () {
                return this.model.check(this.el.find('.gbView').val());
            },
        ...
        groupCollectionView = Backbone.View.extend({
            ...
            validate: function () {
                var feedbackArray = [], temp, tempInput,
                    inputList = _.map(this.subViewCollection, function (view) {
